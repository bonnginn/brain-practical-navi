# 過去のREADME・開発記録 / Archived README

2026-09-07整理前の記録です。未公開・進行中などの記述は当時の状態で、現在の案内ではありません。最新の状況は [再開メモ](RESUME_SUMMARY.md)、利用案内は [README](../README.md) を参照してください。

---

# 脳実習ナビ

[短い現状・次回作業メモ / Current checkpoint and next steps](RESUME_SUMMARY.md) — 追加の自律開発は停止中。矢状断の「前＝左」は次回更新の予定で、現在の公開版には未反映です。
