...
const root=resolve('dist'),out=resolve(`work/anatomy-review/ventricle-classification-browser-${integrated?'integrated-callosal-inferior-v4':'v1'}`);
...
const integratedSha='098edfbf365016c6c53ccf7b7032258db72a4912378c457d348c01613a4a1694';
