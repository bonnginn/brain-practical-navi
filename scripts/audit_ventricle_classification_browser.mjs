...
const root=resolve('dist'),out=resolve(`work/anatomy-review/ventricle-classification-browser-${integrated?'integrated-callosal-followup-v3':'v1'}`);
...
const integratedSha='8cc65edf36e1e3a420168bfb663d6440418dd67189808263d11c180c4b403d16';
