...
def main():
    ...
    new_path = b.ROOT/'tests/fixtures/bigbrain-practical-segmentation-pre-callosal-followup-5348.bin.gz' if args.callosal else b.ROOT/'tests/fixtures/bigbrain-practical-segmentation-pre-callosum-930e.bin.gz'
    old_sha = '930eaaed7eed8782b1b162f3aa5c59c2428f4062d0d2da3a9a1cb563f49b7db7' if args.callosal else 'b75a24903ec08526b3e7f08df9efc8cee15af80d86bb96a821260913a2b176f3'
