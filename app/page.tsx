...
export default function Home() {
  ...
  function openOverlay(key:OverlayMode){overlayReturnFocus.current=document.activeElement instanceof HTMLElement?document.activeElement:null;window.history.pushState(null,"",`#workspace/${key}`);setHelpOpen(key==="help");setOfflineOpen(key==="offline");setDeviceCheckOpen(key==="device-check");setFeedbackOpen(key==="feedback");setLegalOpen(key==="legal")}
