...
export default function Home() {
  ...
  const quizHighlight=useMemo<HighlightLayer[]>(()=>surfaceQuiz||neurovascularQuiz?[]:[{ids:sectionQuizTarget.bigbrainIds??[],color:sectionQuizTarget.rgb}],[sectionQuizTarget,surfaceQuiz,neurovascularQuiz]);
  ...
  const quizNeurovascularHighlight=useMemo<HighlightLayer[]>(()=>neurovascularQuiz?[{ids:neurovascularQuizTarget.ids,color:[255,255,255]}]:[],[neurovascularQuiz,neurovascularQuizTarget]);
