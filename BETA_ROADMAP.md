...
- [x] 小画面でも主要操作が画面外へ消えず、デスクトップでは観察領域を不必要に縮めない（760 px以下は6ワークスペース下部ドックと画面別設定シートを使う専用Web UI、761 px以上はPC UI。1366、760 / 761、391、390、320 pxで確認。320 pxは上部操作名と標本着脱群も専用配置）。
